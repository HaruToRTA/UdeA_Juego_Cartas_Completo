...
public class FrmJuego extends JFrame {
    ...
    public FrmJuego() {
        ...
        tpJugadores.addTab("iRed__", pnlJugador1);
        tpJugadores.addTab("Faustacio", pnlJugador2);
    ...
    private void btnVerificarClick(ActionEvent evt) {
        switch (tpJugadores.getSelectedIndex()) {
            case 0:
                JOptionPane.showMessageDialog(null, jugador1.mostrarEscaleras());
                JOptionPane.showMessageDialog(null, jugador1.calcularPuntaje());
                JOptionPane.showMessageDialog(null, jugador1.getGrupos());
                break;
            case 1:
                JOptionPane.showMessageDialog(null, jugador2.mostrarEscaleras());
